...
def set(c, scheme="dark", intensity="hard"):
    ...
    c.colors.tabs.bar.bg = "#1e3a5f"
    c.colors.tabs.even.bg = "#1e3a5f"
    c.colors.tabs.odd.bg = "#1e3a5f"
    c.colors.tabs.even.fg = t["fg"]
    c.colors.tabs.odd.fg = t["fg"]
    c.colors.tabs.selected.even.bg = "#112b3c"
    c.colors.tabs.selected.odd.bg = "#112b3c"
