...
#+RESULTS:
: ((buffer-predicate . doom-buffer-frame-predicate) (bottom-divider-width . 1) (alpha-background . 80) (vertical-scroll-bars) (tool-bar-lines . 0) (menu-bar-lines . 0) (internal-border-width . 15) (right-divider-width . 30) (left-fringe . 8) (right-fringe . 8) (scroll-bar-width . 8))
